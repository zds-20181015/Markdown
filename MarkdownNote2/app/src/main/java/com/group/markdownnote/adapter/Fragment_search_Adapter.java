...
public class Fragment_search_Adapter extends BaseAdapter {
    ...
    public Fragment_search_Adapter(List<String> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Fragment_search_Adapter.ViewHolder mHolder = null;

        if(convertView == null){
            mHolder = new Fragment_search_Adapter.ViewHolder();
            ...
            mHolder = (Fragment_search_Adapter.ViewHolder) convertView.getTag();
        }
