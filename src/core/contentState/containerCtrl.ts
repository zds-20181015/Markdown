...
const containerCtrl = (ContentState: any) => {
  ...
  ContentState.prototype.handleContainerBlockClick = function (figureEle: any) {
    const { id } = figureEle
  ...
  ContentState.prototype.updateMathBlock = function (block: any) {
