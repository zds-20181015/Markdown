...
const adjustOffset = (offset: any, block: any, event: any) => {
  if (
...
const arrowCtrl = (ContentState: any) => {
  ContentState.prototype.findNextRowCell = function (cell: any) {
  ...
  ContentState.prototype.findPrevRowCell = function (cell: any) {
    if (cell.functionType !== 'cellContent') {
      throw new Error(
        `block with type ${cell && cell.type} is not a table cell`
      )
  ...
  ContentState.prototype.docArrowHandler = function (event: any) {
  ...
  ContentState.prototype.arrowHandler = function (event: any) {
