...
function InlineLexer(this: any, links: any, footnotes: any, options: any) {
  this.options = options || defaultOptions
  this.links = links
  this.footnotes = footnotes
  this.rules = normal
  this.renderer = this.options.renderer || new (Renderer as any)()
...
InlineLexer.prototype.outputLink = function (cap: any, link: any) {
