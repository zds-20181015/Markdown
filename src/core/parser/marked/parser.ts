...
function Parser(this: any, options: any) {
  this.tokens = []
  this.token = null
  this.footnotes = null
  this.footnoteIdentifier = ''
  this.options = options || defaultOptions
  this.options.renderer = this.options.renderer || new (Renderer as any)()
  this.renderer = this.options.renderer
  this.renderer.options = this.options
  this.slugger = new (Slugger as any)()
}
...
Parser.prototype.parse = function (src: any) {
  this.inline = new (InlineLexer as any)(src.links, src.footnotes, this.options)
  // use an InlineLexer with a TextRenderer to extract pure text
  this.inlineText = new (InlineLexer as any)(
    src.links,
    src.footnotes,
    Object.assign({}, this.options, { renderer: new (TextRenderer as any)() })
  )
