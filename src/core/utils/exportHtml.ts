...
export const getSanitizeHtml = (markdown: any, options: any) => {
...
class ExportHtml {
  ...
  muya: any
  exportContainer: any
  mathRendererCalled: any
  constructor(markdown: any, muya: any) {
  ...
  async renderMermaid() {
    ...
    for (const code of codes) {
      ...
      const mermaidContainer: any = document.createElement('div')
  ...
  async renderDiagram() {
    ...
    for (const code of codes) {
      ...
      const render: any = RENDER_MAP[functionType]
  ...
  mathRenderer = (math: any, displayMode: any) => {
  ...
  async renderHtml(toc?: any) {
    ...
    const pathes: any = document.querySelectorAll('path[id^=raphael-marker-]')
...
<body>
   ...
   */
  _prepareHtml(html: any, options: any) {
...
const createTableBody = (html: any) => {
  return `<tbody><tr><td>
...
const createTableHeader = (options: any) => {
...
const createRealFooter = (options: any) => {
